---
title: "Invisible Labor: The Economic Value of Unpaid Childcare"
...
```{r}
#| include: false
# Data-integrity check (not shown in the rendered document): confirm the
# replicate-weight columns exist and are usable before building the design.
...
```{r}
#| include: false
# Sanity check on the primary_caregiver flag (not shown in the document).
